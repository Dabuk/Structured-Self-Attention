...
if classification_type =='binary':
    ...
    classified = True
    print("test acc", evaluate(attention_model,x_test_pad,y_test))
...
if classification_type == 'multiclass':
    train_loader,x_test_pad,y_test,word_to_id = load_data_set(1,MAXLENGTH,model_params["vocab_size"],model_params['batch_size']) #load the reuters dataset
